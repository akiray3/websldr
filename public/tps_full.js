...
var arrTmp1 = new Array(10) 
var arrTmp2 = new Array(10) 
var arrImgType = new Array(10) 
var arrImgNum = new Array(10) 
var arrImgSrc = new Array(10);

//ページの起動時処理
window.onload = function(){
  btnNext.disabled = true
  arrTmp1 = ['p', 'p', 'p', 'p', 'p', 'n', 'n', 'n', 'n', 'n'];
  arrTmp2 = ['01', '02', '03', '04', '05', '01', '02', '03', '04', '05'];
  let flag = 1;
  while(flag > 0){
  ...
  let instImg = ["01", "02", "03", "04", "05", "06", "07"]
...
btnNext.addEventListener('click', 
  function () {
    window.location.href = 'mysurvey_02.html?exp_id=' + exp_id;
  }
)